        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                @can('new_booking_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.new-bookings.index") }}" class="nav-link {{ request()->is("admin/new-bookings") || request()->is("admin/new-bookings/*") ? "active" : "" }}">
                            <i class="fa-fw nav-icon fas fa-book">
                ...
                @can('booing_date_time_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.booing-date-times.index") }}" class="nav-link {{ request()->is("admin/booing-date-times") || request()->is("admin/booing-date-times/*") ? "active" : "" }}">
                            ...
                            <p>
                                {{ trans('cruds.booingDateTime.title') }}
                            </p>
                        </a>
                    </li>
                @endcan
                @can('booking_payment_access')
                    <li class="nav-item">
                        <a href="{{ route("admin.booking-payments.index") }}" class="nav-link {{ request()->is("admin/booking-payments") || request()->is("admin/booking-payments/*") ? "active" : "" }}">
