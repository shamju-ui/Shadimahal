...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.booingDateTime.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.booing-date-times.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="booked_date">{{ trans('cruds.booingDateTime.fields.booked_date') }}</label>
                <input class="form-control date {{ $errors->has('booked_date') ? 'is-invalid' : '' }}" type="text" name="booked_date" id="booked_date" value="{{ old('booked_date') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('time_slot') ? 'is-invalid' : '' }}" type="text" name="time_slot" id="time_slot" value="{{ old('time_slot', '') }}">
